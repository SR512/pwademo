...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <button type="button" class="btn btn-danger addtohome" onclick="addtohome()">Add to Home</button>
...
<script type="application/javascript">
    ...
    if ('serviceWorker' in navigator) {
        navigator.serviceWorker.register('{{asset('serviceworker.js')}}').then(function () {
    ...
    //
    //
    // window.addEventListener('beforeinstall',function (event) {
